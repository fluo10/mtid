...
pub enum Error {
    ...
    #[deprecated(since = "1.0.0", note = "The ParseInteger has been renamed. Use ValueOfRange instead.")]
    #[error("Invalid integer value: epected under {expected}, found {found}.")]
    ParseInteger {
        expected: u64,
        found: u64,
    },
    #[deprecated(since = "1.0.0", note = "The ParseLength has been renamed. Use InvalidLength instead.")]
