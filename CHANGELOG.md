...
### Added
- `Mtid::from_proto_lossy()` function for lossy conversion from the structs generated by prost-build.

### Changed
- Rename `from_int_lossy()` to `from_uint_lossy()`
- (`mtid-cli`) Bump `mtid` to `v0.6.0`.
...
[Unreleased]: https://github.com/fluo10/mtid/compare/v0.6.0...HEAD
